...
class Api {
    ...
    async mapData(data) {
        ...
        console.log('url',`https://b.maps.owm.io/weather/cities/${data.zoom}/${data.x}/${data.y}.geojson?appid=b1b15e88fa797225412429c1c50c122a1`)
        console.log('conf', conf)
 
        await fetch(`https://b.maps.owm.io/weather/cities/${data.zoom}/${data.x}/${data.y}.geojson?appid=b1b15e88fa797225412429c1c50c122a1`, conf)
            .then(checkStatus)
            .then(parseJSON)
            .then(function (data) {
                query = data
